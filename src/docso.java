...
public class docso {
    ...
    static String haiChuSo(int x){
        ...
        switch (hangchuc){
            case 2: return "twenty"+soDonVi(hangdonvi);
            case 3: return "thirty"+soDonVi(hangdonvi);
            case 4: return "fourty"+soDonVi(hangdonvi);
            case 5: return "fifty"+soDonVi(hangdonvi);
            case 6: return "sixty"+soDonVi(hangdonvi);
            case 7: return "seventy"+soDonVi(hangdonvi);
            case 8: return "eighty"+soDonVi(hangdonvi);
            case 9: return "ninety"+soDonVi(hangdonvi);
        }
        return "";
    }
